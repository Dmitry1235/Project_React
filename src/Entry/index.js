...
class Entry extends Component {
    ...
    handleChangeInput(value, fieldName) {
        value ? this.setState({[fieldName]: {value, error: false}}) : this.setState({
            [fieldName]: {
                value,
                error: true
            }
                ...
                <div className="row">
                    ...
                    <div className='Entry col-4'>
                        ...
                        <div>
                            ...
                            <div>
                                <input type='text' className={`${numberPhone.error === true ? 'Red' : ''}`}
                                       value={numberPhone.value}
                                       onChange={(e) => this.handleChangeInput(e.target.value, 'numberPhone')}/>
                            </div>
                        </div>
                        <div>
                            <label>Password</label>
                            <div>
                                <input type='text' className={`${password.error === true ? 'Red' : ''}`}
